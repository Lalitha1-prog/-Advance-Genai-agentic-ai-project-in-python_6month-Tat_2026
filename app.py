...
MODEL_PATH = r"C:\Users\DURGA\Downloads\linear_regression_model.pkl"
model = pickle.load(open(MODEL_PATH, 'rb'))


# Set the title of the Streamlit app
st.title("Salary Prediction App created by lalitha")
...
st.write("The model was trained using a dataset of salaries and years of experience.built model by lalitha")